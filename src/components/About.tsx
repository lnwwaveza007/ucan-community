    ...
    <section id="about" className="py-16 md:py-20">
      <div className="container-page px-4">
        ...
        <div className="grid md:grid-cols-[1.2fr_1fr] gap-6 items-stretch">
          <div className="rounded-[24px] p-8 text-white bg-[radial-gradient(1200px_400px_at_0%_-10%,rgba(255,76,112,0.2),transparent_60%),radial-gradient(1200px_400px_at_100%_-10%,rgba(255,142,66,0.2),transparent_60%),linear-gradient(180deg,var(--brand-blue-800),var(--brand-blue-900))]">
            <div className="text-sm uppercase tracking-[0.18em] text-white/80">Vision</div>
            <h2 className="mt-2 text-2xl md:text-3xl font-bold leading-snug">To foster the Entrepreneurial Mindset among university students.</h2>
          </div>
          <div className="rounded-[24px] p-8 border border-[var(--color-muted-300)] bg-white dark:bg-[var(--color-card-dark)]">
            <div className="text-sm uppercase tracking-[0.18em] text-[var(--color-muted-700)]">Mission</div>
            <p className="mt-2 text-lg font-medium">We deliver on our mission in three focused ways:</p>
            <div className="mt-5 grid grid-cols-1 gap-3">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <div className="font-semibold">Build networks in specific fields to apply entrepreneurship skills</div>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  <div className="font-semibold">Provide knowledge through workshops and training</div>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  <div className="font-semibold">Build collaboration with organizations and partners</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="mt-10 container-page px-4">
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
          {[
            { v: "6", l: "Projects", c: "from-[var(--accent-pink)] to-[var(--color-accent-sun)]" },
            { v: "25+", l: "Session Workshops\nTalks, pitching, and\nhands-on learning", c: "from-[var(--color-accent-sun)] to-[var(--color-accent-orange)]" },
            { v: "30+", l: "Community Meetups", c: "from-[var(--color-accent-orange)] to-[var(--accent-pink)]" },
            { v: "60+", l: "UCAN Team Members\nKMUTT students from 4 faculties", c: "from-[var(--highlight-green)] to-[var(--color-accent-sun)]" },
            { v: "439+", l: "UCAN Sandbox participants\nincluding school students,\nuniversity students, and KMUTT staff", c: "from-[var(--brand-blue-800)] to-[var(--accent-pink)]" },
            { v: "192+", l: "Students in the UCAN Sandbox\nentrepreneurship network", c: "from-[var(--accent-pink)] to-[var(--highlight-green)]" },
          ].map((s) => (
