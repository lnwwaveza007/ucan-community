...
export default function EntrepreneurForum2025SuccessPage() {
    ...
    <div className="min-h-screen bg-[var(--background)] text-[var(--foreground)]">
      <div className="container-page max-w-2xl mx-auto px-4 py-10 mb-30 h-[calc(100vh-200px)] flex items-center justify-center">
        <div className="glass-card rounded-[var(--radius-xl)] p-6 md:p-8 space-y-6 text-center flex flex-col items-center justify-center">
          <h1 className="text-3xl font-semibold">{messages.entrepreneurForumSuccess.title}</h1>
          <motion.div
          ...
          >
            ...
            <p className="text-[var(--muted-foreground)]">
              {messages.entrepreneurForumSuccess.message}
              <br /><br />
              <span className="font-bold">{messages.entrepreneurForumSuccess.emphasize}</span>
            </p>
            <div className="flex items-center justify-center gap-3">
              ...
              >
                {messages.entrepreneurForumSuccess.backHome}
              </Link>
            </div>
          </motion.div>
        </div>
